			...
			> -->
				<!-- <swiper-item v-for="tabItem in tabBars" :key="tabItem.id"> -->
					<scroll-view 
						...
						-->
						<view v-for="(item, index) in tabBars[0].newsList" :key="index" class="news-item" @click="navToDetails(item)">
						...
						<mix-load-more :status="tabBars[0].loadMoreStatus"></mix-load-more>
					</scroll-view>
			<!-- 	</swiper-item>
			</swiper> -->
