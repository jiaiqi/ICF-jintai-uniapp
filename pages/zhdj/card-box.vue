		...
		<view class="bottom">
			...
			<view class="labelBox">
				<view class="label" :style="{backgroundColor:sex==0?'#7BD8FF':'#F3C9F5'}">
					<view class=""  :style="{fontSize:'16px' }"></view>{{old}}</view>
				<view class="label" :style="{backgroundColor:'#A4C742'}">身份证号 : {{constellation}}</view>
			</view>
	...
	.cardBox{
		...
		.bottom{
			...
			.star{
				...
				right: 50rpx;
				border-radius: 50%;
				background-image: linear-gradient(to bottom left, red , #E51C23);
				display: flex;
				justify-content: center;
				align-items: center;
