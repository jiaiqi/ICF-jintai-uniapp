  ...
  <view>
    <view class="cu-form-group " v-if="fieldData.display">
      ...
      <view v-if="pageFormType === 'detail'">
		...
		></textarea> -->
		<view @tap='toEditor(fieldData.value)'  v-if="fieldData.col_type === 'Note'" v-html="fieldData.value" class="editors">
      ...
      <view class="" v-if="pageFormType === 'form' || pageFormType === 'add' || pageFormType === 'update'" >
		...
		<!-- fieldData.type === 'list' -->     
		 <picker
		        @change="PickerChange($event,fieldData)"
		        :value="indexDown"
		        :range="picker"
		        v-if="fieldData.col_type === 'Dict'"
		      >
